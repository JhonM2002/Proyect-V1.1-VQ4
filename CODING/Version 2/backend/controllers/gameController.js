...
exports.getAllHistories = async (req, res) => {
  ...
  exports.addGameHistory = async (req, res) => {
    try {
      ...
      // Crear un nuevo historial de juego
...
exports.getAllTherapists = async (req, res) => {
  try {
    const therapists = await Therapist.find({}, 'nombre cedula'); // Solo traer los campos necesarios
...
exports.getAllPatients = async (req, res) => {
  try {
    const patients = await Patient.find({}, 'nombre cedula'); // Relacionar con el terapeuta
